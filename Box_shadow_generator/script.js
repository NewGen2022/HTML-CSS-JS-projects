...
function generateStyles() {
  ...
  const boxShadow = `${
    shadowInset ? "inset" : ""
  }  ${xShadow}px ${yShadow}px ${blurRadius}px ${spreadRadius}px
  ...
  styles.textContent = `box-shadow: ${boxShadow}; border-radius: ${borderRadius}px;`;
}

// Function to convert hex color and opacity to to rgba format
